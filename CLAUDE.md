...
docs/
  ...
  RENDERER_CONTRACT_DESIGN.md  # The framework-seam renderer boundary: (data, fidelity, width) → Block, renderer= seam, transcription default, width-at-the-offer, ref_schemes declaration (DRAFT — 0.11/M4)
